...
| `SS_DEFAULT_SNAPSHOT_SUPERSPLAT` | `OFF` | Start the training viewport and snapshot selector in SuperSplat (Y-up) mode for a custom build. Normal builds remain Z-up; the selector remains editable. |
